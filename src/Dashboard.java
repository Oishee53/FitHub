    ...
    public void graph(Member member) {
        ...
        try (BufferedReader bufferedReader = new BufferedReader(new FileReader("WorkoutFile.csv"))) {
            ...
            while ((line = bufferedReader.readLine()) != null) {
                ...
                if(member.getEmailAddress().equalsIgnoreCase(data[0]) && date[1].equals("01") )
                    january = january + Double.parseDouble(data[4]);

                else if(member.getEmailAddress().equalsIgnoreCase(data[0]) && date[1].equals("02") )
                    february = february + Double.parseDouble(data[4]);
                else if(member.getEmailAddress().equalsIgnoreCase(data[0]) && date[1].equals("03") )
                    march = march + Double.parseDouble(data[4]);
                 else if (member.getEmailAddress().equalsIgnoreCase(data[0]) && date[1].equals("04"))
                    april = april + Double.parseDouble(data[4]);
                else if (member.getEmailAddress().equalsIgnoreCase(data[0]) && date[1].equals("05"))
                    may = may + Double.parseDouble(data[4]);
                else if (member.getEmailAddress().equalsIgnoreCase(data[0]) && date[1].equals("06"))
                    june = june + Double.parseDouble(data[4]);
                else if (member.getEmailAddress().equalsIgnoreCase(data[0]) && date[1].equals("07"))
                    july = july + Double.parseDouble(data[4]);
                else if (member.getEmailAddress().equalsIgnoreCase(data[0]) && date[1].equals("08"))
                    august = august + Double.parseDouble(data[4]);
                else if (member.getEmailAddress().equalsIgnoreCase(data[0]) && date[1].equals("09"))
